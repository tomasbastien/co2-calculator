...
'v2.6.4-release_date' : '29 septembre 2024',
'v2.6.4-release_notes' : '<li><strong>Mise à jour de l\'API Impact CO2</strong> de l\'ADEME : ajout d\'un fichier json de référence sur le serveur web (régulièrement mis à jour) au lieu d\'une requête directe vers leur API</li>',
}
