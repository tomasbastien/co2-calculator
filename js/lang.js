...
var changelog_langEn = {    
    ...
    'v2.3.2-release-notes' : '<li class="ml-3"><i class="mdi mdi-circle-medium mr-2"></i>Bug fixes :</strong> resolving issue <strong>#5</strong></li><li>Adding Openrouteservice fallback for unsuccessful Nominatim queries</li>',
...
var changelog_langFr = {    
    ...
    'v2.3.2-release-notes' : '<li class="ml-3"><i class="mdi mdi-circle-medium mr-2"></i>Correction de bugs :</strong> correction du bug <strong>#5</strong></li><li>Ajout d\'une requête vers Openrouteservice si celle vers Nominatim échoue</li>',
